...
class Codepress_Column_Shortcodes {
	...
	private function is_edit_screen() {
		...
		$allowed_screens = apply_filters( 'cpsh_allowed_screens', array( 'post-new.php', 'page-new.php', 'post.php', 'page.php', 'profile.php', 'user-edit.php', 'user-new.php', 'edit-tags.php','term.php' ) );
	...
	private function has_permissions() {
		return current_user_can( 'edit_posts' ) || current_user_can( 'edit_pages' ) || current_user_can( 'edit_tags' ) | current_user_can( 'edit_terms' ) ;
	}
